...
// GENERATED by the backend (config.js is the dist's own hook:
// window.__METACUBEXD_CONFIG__.defaultBackendURL = '/api/mihomo';
// the secret is injected by the proxy, never sent to the browser).
//
